...
function NewStoryForm({ storyTitle, setStoryTitle, storyContent, setStoryContent, readTime, setReadTime, storyTopic, setStoryTopic, topics }) {
    ...
    return (
        <div>
            ...
            <NewStoryInputs readTime={readTime} setReadTime={setReadTime} storyTopic={storyTopic} setStoryTopic={setStoryTopic} topics={topics}/>
